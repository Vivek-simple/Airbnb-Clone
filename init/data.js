const sampleListings = [
  ...
  },
  {
    ...
    image: {
      filename: "listingimage",
      url: "https://a0.muscache.com/im/pictures/34c1ddc3-cb25-480f-82ed-a082f2f2cebc.jpg?im_w=960",
    },
    category:['rooms'],
    price: 1200,
    location: "Dhamani",
  ...
  },
  {
  ...
  },
    {
      ...
      description: "Experience luxury living in this stunning beachfront villa. Enjoy breathtaking ocean views and private beach access.",
      image: {
    ...
    },
    {
      ...
      description: "Relax and unwind in this cozy beach house just steps away from the shore. Perfect for a beach getaway with family or friends.",
      image: {
    ...
    },
    {
      ...
      description: "Enjoy panoramic mountain views from this charming chalet. Perfect for a cozy retreat in the heart of the mountains.",
      image: {
      ...
      geometry: {
        type: 'Point',
        coordinates: [77.1710, 31.1048]
      }
    },
    {
      title: "Private Pool Villa",
      description: "Indulge in luxury at this private pool villa. Relax by the poolside and enjoy stunning views of the surrounding mountains.",
      image: {
        filename: "pool_villa",
    ...
    },
    {
      ...
      description: "Escape to this charming lakefront cottage for a peaceful getaway. Enjoy fishing, boating, and breathtaking sunsets.",
      image: {
    ...
    
      {
        ...
        description: "Escape to this serene riverside retreat surrounded by lush greenery. Enjoy fishing, birdwatching, and tranquil walks along the riverbank.",
        image: {
      ...
      },
      {
        ...
        description: "Indulge in luxury at this breathtaking mountain resort. Enjoy world-class amenities and panoramic views of the Himalayas.",
        image: {
      ...
      },
      {
        ...
        description: "Stay in a charming boat house and enjoy life on the water. Explore the serene backwaters and experience the rich culture of Kerala.",
        image: {
          filename: "boat_house",
      ...
      },
      {
        ...
        description: "Experience tranquility at this lakeside cabin retreat. Enjoy stunning views, fishing, and kayaking on the pristine lake.",
        image: {
      ...
      },
      {
        ...
        description: "Stay in a charming beachfront bungalow and enjoy the sound of the waves. Relax on the sandy shores and soak in the sun.",
        image: {
      ...
      },
      {
        ...
        description: "Escape to this secluded mountain retreat for a peaceful getaway. Enjoy panoramic views of the surrounding peaks and valleys.",
        image: {
      ...
      },
      {
        ...
        description: "Relax and unwind at this luxurious poolside villa. Enjoy private pool access and lush tropical surroundings.",
        image: {
      ...
      },
      {
        ...
        description: "Stay in a cozy cottage with stunning views of the lake. Enjoy peaceful walks by the water and picturesque sunsets.",
        image: {
      ...
      },
      {
        ...
        description: "Experience rustic charm at this riverside log cabin. Relax on the porch and listen to the soothing sounds of the river.",
        image: {
